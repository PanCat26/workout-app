...
namespace WorkoutApp.Tests.Service
{
    public class OrderServiceTests
    {
        ...
        public async Task CreateOrderFromCartAsync_CreatesOrderAndDeletesCartItems()
        {
            ...
            {
                new CartItem(2, new Product(1, "Mat", 20.0m, 10, new Category(1, "Gear"), "M", "Black", "Yoga mat", null),1),
                new CartItem(1, new Product(2, "Dumbbell", 50.0m, 5, new Category(2, "Weights"), "L", "Silver", "Iron dumbbell", null),1)
            };
            ...
            mockOrderRepo.Verify(repo => repo.CreateAsync(It.Is<Order>(o =>
                ...
                o.OrderItems.Any(i => i.Product.ID == 1 && i.Quantity == 1) &&
